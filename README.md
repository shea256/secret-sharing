...
[![PyPI](https://img.shields.io/pypi/v/nginsecretsharing.svg)](https://pypi.python.org/pypi/nginsecretsharing/)
[![PyPI](https://img.shields.io/pypi/dm/nginsecretsharing.svg)](https://pypi.python.org/pypi/nginsecretsharing/)
[![PyPI](https://img.shields.io/pypi/l/nginsecretsharing.svg)](https://github.com/ginsburgnm/nginsecret-sharing/blob/master/LICENSE)

A library for sharding and sharing secrets (like Bitcoin private keys), using shamir's secret sharing scheme.

## Installation

    >>> pip install nginsecretsharing
...
#### Splitting into shares
    ...
    >>> from nginsecretsharing import SecretSharer
...
#### Splitting into shares
    ...
    >>> from nginsecretsharing import PlaintextToHexSecretSharer
...
#### Splitting into reliably printable base58 shares
    ...
    >>> from nginsecretsharing import BitcoinToB58SecretSharer
...
#### Splitting into reliably transcribable [base32](http://en.wikipedia.org/wiki/Base32) shares
    ...
    >>> from nginsecretsharing import BitcoinToB32SecretSharer
...
#### Splitting into reliably transcribable [zbase32](http://philzimmermann.com/docs/human-oriented-base-32-encoding.txt) shares
    ...
    >>> from nginsecretsharing import BitcoinToZB32SecretSharer
...
#### Splitting into shares
    ...
    >>> from nginsecretsharing import secret_int_to_points, points_to_secret_int
...
#### Splitting into shares
    ...
    >>> from nginsecretsharing import SecretSharer, base64_chars
